...
<iframe src="https://open.spotify.com/playlist/14l87w1okIlWsa68eNqGka?si=zFY4qK0dTT29QEajSLL0yg" width="582" height="80" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
...
These chromagrams visualize the lack of structure Frusciante's music had in his desent and the 
...
As you can see, *TROWFTD* remains triumphs in maintaining a (somewhat) stable tempo. The tempogram once again doubles and very occasionally quadruples the original bpm of 92.3, but coincidentally like "Running Away Into You" does something strange at the last part of the song. This time it resembles a DNA helix, caused by the overpowering synthesizer being played. 
